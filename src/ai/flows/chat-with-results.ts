...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a helpful AI assistant embedded in the TrustCheck application. Your role is to answer user questions about the analysis results they have just received.
