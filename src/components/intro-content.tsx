    ...
    <Card className="bg-card border-border shadow-md">
      <CardContent className="p-6 md:p-8 grid md:grid-cols-3 gap-8 items-center">
        <div className="md:col-span-1 flex justify-center items-center">
          <Image
            src="https://i.ibb.co/5XDPH39Y/main-dog.png"
            alt="Byte - the app mascot, a German Shepherd in a police vest"
            width={256}
            height={256}
        ...
        <div className="md:col-span-2 space-y-4 text-foreground/90">
            ...
            <p className="text-base leading-relaxed">
             ...
             <p className="text-base leading-relaxed italic text-muted-foreground">
                W centrum całego procesu stoi <strong>Byte</strong> – wierny policyjny owczarek i maskotka
